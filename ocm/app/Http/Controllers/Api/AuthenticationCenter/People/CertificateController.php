...
class CertificateController extends Controller
{
    ...
    public function create(Request $request){
        ...
        $record = RecordModel::create([
            ...
            'start' => strlen( $request->start_date ) ? \Carbon\Carbon::parse( $request->start_date )->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') ,
            'end' => strlen( $request->end_date ) ? \Carbon\Carbon::parse( $request->end_date )->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') ,
