...
namespace App\Http\Controllers\Api\Hradmin\Officer;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use App\Models\Officer\OfficerRankByWorking as RecordModel;
...
class OfficerRankByWorkingController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $crud->setRelationshipFunctions([
            ...
            'rank' => [ 'id' , 'ank' , 'krobkhan' , 'rank' , 'desp' , 'name' ] ,
            'previousRank' => [ 'id' , 'ank' , 'krobkhan' , 'rank' , 'desp' , 'name' ]
        ]);
    ...
    public function create(Request $request){
        ...
        $record = RecordModel::create([
            ...
            'sub_sub_organization' => $request->sub_sub_organization?? '' ,
            'date' => $request->date?? '' ,
