<template>
  <div
    class="birth-information font-sr relative flex flex-wrap mx-auto"
    :style="'width: 21cm;'"
  >
    <div
      v-if="officer != undefined && officer != null"
      class="p-2 flex flex-wrap text-left"
    >
      <div class="heading w-full mb-4 relative flex flex-wrap">
        <div class="font-moul w-full leading-6 text-center">
        ...
        <div
          class="font-tacteing w-full text-center h-10 -mt-2"
        ...
        <div class="organization w-1/2 relative my-2 pt-6 text-left -mt-2">
          ...
          <div
            v-if="officer.organization != undefined"
            class="font-moul w-full leading-6"
          >
            {{ officer.organization.name }}
          </div>
        </div>
        <div
          class="profile-photo w-1/2 relative my-2 -mt-2"
          style="height: 3.2cm"
        >
          <div
            class="absolute top-0 right-0 mr-12"
            style="width: 3.2cm; height: 4.2cm"
          >
            <img
              v-if="
                officer.image != undefined &&
                officer.image != null &&
            ...
            />
            <img
              v-if="officer.image == undefined || officer.image == null"
              :src="ocmLogoUrl"
              class="border border-gray-200"
              style="width: 100%; height: 100%; opacity: 50%; padding: 10px"
            />
          </div>
        </div>
      </div>
      <div class="font-moul w-full pb-2 text-center mb-2">
      ...
      <div class="body w-full">
        <div class="form-panel w-full mx-auto">
          <div class="w-full mb-4">
            <div class="relative w-full mb-2 font-moul text-left">
            ...
            >
              <tbody>
                <tr>
                  ...
                  <td>
                    {{
                      "គោត្តនាម ៖ " + officer.people.lastname
                    }}
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    {{ " នាមខ្លួន ៖ " + officer.people.firstname }}
                  </td>
                  <td colspan="2">
                    ភេទ ៖
                    {{
                      parseInt(officer.people.gender) == 1 ? "ប្រុស" : "ស្រី"
                    }}
                  </td>
                </tr>
                <tr>
                  ...
                  <td colspan="3">
                    {{
                      "គោត្តនាម ៖ " + officer.people.enlastname
                    }}
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    {{ " នាមខ្លួន ៖ " + officer.people.enfirstname }}
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    {{
                      officer.people.dob != null &&
                      officer.people.dob.length > 0
                        ? $toKhmer(
                            dateFormat(
                              new Date(officer.people.dob),
                              "dd-mm-yyyy",
                            ),
                          )
                        : ""
                ...
                <tr>
                  ...
                  <td colspan="3">
                    ...
                    {{
                      officer != null &&
                      officer.people != undefined &&
                      officer.people != null &&
                      officer.people.address != null
                        ? $toKhmer(officer.people.address)
                        : ""
                    }}
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    {{
                      ...
                      officer.people != undefined &&
                      officer.people != null &&
                      officer.people.current_address != null
                        ? $toKhmer(officer.people.current_address)
                        : ""
                    }}
                  </td>
                </tr>
                ...
                <tr
                  v-if="
                    officer.people.passports != null &&
                    officer.people.passports != undefined &&
                    officer.people.passports.length > 0
                  "
                >
                  ...
                  <td class="">
                    ...
                    {{
                      $toKhmer(
                        formatDateSafe(
                          officer.people.passports[0].effective_date,
                        ),
                      )
                    }}
                  </td>
                  <td class="">
                    ...
                    {{
                      $toKhmer(
                        formatDateSafe(
                          officer.people.passports[0].expired_date,
                        ),
                      )
                    }}
                  </td>
                ...
                <tr>
                  ...
                  <td class="flex">
                    <div class="w-24 flex leading-6">
                      <svg
                        v-if="parseInt(officer.people.body_condition) == 0"
                    ...
                    <div class="w-24 flex leading-6">
                      <svg
                        v-if="parseInt(officer.people.body_condition) == 1"
                        class="w-6 h-6 mr-1 text-gray-500"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 32 32"
                  ...
                  <td colspan="2" class="">
                    ប្រភេទពិការភាព ៖
                    {{
                      parseInt(officer.people.body_condition) == 1
                        ? officer.people.body_condition_desp
                        : ""
                    }}
                  </td>
                </tr>
              ...
              <tbody>
                <tr>
                  <td colspan="4" class="flex">
                    <div class="w-24 flex leading-6">
                      <svg
                        v-if="officer.people.marry_status == 'single'"
                        class="w-6 h-6 mr-1 text-gray-500"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 32 32"
                    ...
                    <div class="w-40 flex leading-6">
                      <svg
                        v-if="officer.people.marry_status == 'divorced'"
                        class="w-6 h-6 mr-1 text-gray-500"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 32 32"
                ...
                <tr>
                  <td>
                    <div class="relative w-full my-2 font-moul">
                      ខ.១ ព័ត៌មានប្រពន្ធឬប្ដី
                    </div>
                    <table class="w-full">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            {{
                              officer.people.wedding_certificates !=
                                undefined &&
                              officer.people.wedding_certificates.length > 0
                                ? $toKhmer(
                                    officer.people.wedding_certificates[0]
                                      .wedding_number,
                                  )
                                : ""
                            }}
                            ...
                            <div class="w-40 flex leading-6">
                              <svg
                                v-if="
                                  officer.people.wedding_certificates !=
                                    undefined &&
                                  officer.people.wedding_certificates.length >
                                    0 &&
                                  officer.people.wedding_certificates[0]
                                    .spouse_death == 0
                                "
                              ...
                              <svg
                                v-if="
                                  officer.people.wedding_certificates ==
                                    undefined ||
                                  officer.people.wedding_certificates == null
                                "
                                class="w-6 h-6 mr-1 text-gray-500"
                                xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <tr>
                  <td>
                    <div class="relative w-full mt-2 font-moul">
                      ខ.២ ព័ត៌មានកូន
                    </div>
                    <table class="w-full">
                      <tbody>
                        <tr>
                          <td class="w-48 pb-2">
                            ...
                            {{
                              ...
                              officer.people.wedding_certificates.length > 0 &&
                              officer.people.wedding_certificates[0]
                                .birth_certificates != undefined &&
                              officer.people.wedding_certificates[0]
                                .birth_certificates != null &&
                              officer.people.wedding_certificates[0]
                                .birth_certificates.length > 0
                                ? $toKhmer(
                                    officer.people.wedding_certificates[0]
                                      .birth_certificates.length,
                                  )
                                : ""
                            }}
                            នាក់
                          ...
                          <td class="w-48">
                            ...
                            {{
                              ...
                              officer.people.wedding_certificates[0]
                                .birth_certificates.length > 0
                                ? $toKhmer(
                                    officer.people.wedding_certificates[0].birth_certificates.filter(
                                      (b) => b.gender != "male",
                                    ).length,
                                  )
                                : ""
                        ...
                        <tr>
                          <td colspan="2">
                            <table class="w-full">
                              ...
                              >
                                <tr
                                  v-for="(o, i) in officer.people
                                    .wedding_certificates[0].birth_certificates"
                                  :key="i"
                                >
                                  <td class="w-24">{{ $toKhmer(i + 1) }}.</td>
                                  <td>{{ o.lastname + " " + o.firstname }}</td>
                                  <td>
                                    {{ o.gender == "male" ? "ប្រុស" : "ស្រី" }}
                                  </td>
                ...
                <tr>
                  <td>
                    <div class="relative w-full my-2 font-moul">
                      ខ.៣ ព័ត៌មានឪពុកនិងម្ដាយបង្កើត
                    </div>
                    <div class="relative w-full pb-2 font-moul">
                      ព័ត៌មានឪពុក
                    </div>
                    <table class="w-full">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {{
                              officer.people.father_dob != undefined &&
                              officer.people.father_dob.length > 0
                                ? $toKhmer(
                                    dateFormat(
                                      new Date(officer.people.father_dob),
                                      "dd-mm-yyyy",
                                    ),
                                  )
                                : ""
                          ...
                          <td class="">
                            ជនជាតិ ៖ {{ officer.people.father_national }}
                          </td>
                          <td class="">
                            សញ្ជាតិ ៖ {{ officer.people.father_nationality }}
                          </td>
                        </tr>
                        <tr>
                          <td>ទីកន្លែងកំណើត</td>
                        ...
                        <tr>
                          <td>អាសយដ្ឋានបច្ចុប្បន្ន</td>
                          <td colspan="3">
                            {{ officer.people.father_address }}
                          </td>
                        </tr>
                        <tr>
                          <td>មុខរបរបច្ចុប្បន្ន</td>
                          <td colspan="3">
                            {{ officer.people.father_profession }}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    <div class="relative w-full mt-2 pb-2 font-moul">
                      ព័ត៌មានម្ដាយ
                    </div>
                    <table class="w-full">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {{
                              officer.people.mother_dob != undefined &&
                              officer.people.mother_dob.length > 0
                                ? $toKhmer(
                                    dateFormat(
                                      new Date(officer.people.mother_dob),
                                      "dd-mm-yyyy",
                                    ),
                                  )
                                : ""
                          ...
                          <td class="">
                            ជនជាតិ ៖ {{ officer.people.mother_national }}
                          </td>
                          <td class="">
                            សញ្ជាតិ ៖ {{ officer.people.mother_nationality }}
                          </td>
                        </tr>
                        <tr>
                          <td>ទីកន្លែងកំណើត</td>
                        ...
                        <tr>
                          <td>អាសយដ្ឋានបច្ចុប្បន្ន</td>
                          <td colspan="3">
                            {{ officer.people.mother_address }}
                          </td>
                        </tr>
                        <tr>
                          <td>មុខរបរបច្ចុប្បន្ន</td>
                          <td colspan="3">
                            {{ officer.people.mother_profession }}
                          </td>
                        </tr>
                      </tbody>
                    </table>
            ...
            <table class="w-full">
              <tbody>
                <tr>
                  ...
                  <td>
                    {{
                      officer.people.emergency_gender == 0 ? "ស្រី" : "ប្រុស"
                    }}
                  </td>
                </tr>
                <tr>
        ...
        <div class="form-panel w-full mx-auto">
          <div class="w-full">
            <div class="relative w-full my-2 font-moul">
              ឃ- កំរិតវប្បធម៌ទូទៅ ការបណ្ដុះបណ្ដាលមុខវិជ្ជាជីវៈ
              និងការបណ្ដុះបណ្ដាលបន្ត
            </div>
            <table class="w-full">
              <tbody>
                <tr>
                    ...
                    <table class="inside w-full border border-gray-100">
                      ...
                      <tbody>
                        <tr>
                          <td
                            colspan="7"
                            class="border-b border-gray-100 font-moul"
                          >
                            ១. កម្រិតវប្បធម៌ទូទៅ (សូមបំពេញកម្រិតចុងក្រោយ)
                          </td>
                        </tr>
                        <tr
                          v-for="(certificate, index) in officer.people
                            .certificates.first"
                          :key="index"
                        >
                          <td class="border-b border-gray-100">
                            {{
                              certificate.group != undefined &&
                              certificate.group != null
                                ? certificate.group.education_level
                                : ""
                            }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ certificate.place_name }}
                          </td>
                          <td class="border-b border-gray-100">
                          ...
                          <td class="border-b border-gray-100">
                            {{
                              certificate.group != undefined &&
                              certificate.group != null
                                ? certificate.certificate_group_id == 3
                          ...
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(certificate.start) }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(certificate.end) }}
                          </td>
                        </tr>
                        <tr>
                          <td
                            ...
                            class="border-b border-gray-100 font-moul"
                          >
                            ២. កម្រិតបណ្ដុះបណ្ដាលវិជ្ជាជីវៈមូលដ្ឋាន
                            និងក្រោយមូលដ្ឋាន (សូមបំពេញតាមលំដាប់ថ្មីទៅចាស់)
                          </td>
                        </tr>
                        <tr
                          v-for="(certificate, index) in officer.people
                        ...
                        >
                          ...
                          <td class="border-b border-gray-100">
                            {{
                              certificate.group != undefined &&
                              certificate.group != null
                                ? certificate.certificate_group_id == 8
                                  ? certificate.certificate_note
                                  : certificate.group.name
                                : ""
                            }}
                        ...
                        <tr>
                          <td
                            ...
                            class="border-b border-gray-100 font-moul"
                          >
                            ៣. វគ្គបណ្ដុះបណ្ដាលផ្សេងៗ (សូមបំពេញវគ្គសក្សាថ្មី
                            សំខាន់ៗ និងចាំបាច់)
                          </td>
                        </tr>
                        <tr
        ...
        <div class="form-panel w-full mx-auto">
          <div class="w-full">
            <div class="relative w-full my-4 font-moul">
              ង- ភាសាបរទេស (សូមបំពេញនូវកម្រិតចំណេះដឹងភាសាបរទេស ពីល្អ មធ្យម
              ខ្សោយ)
            </div>
            <table class="inside w-full">
              ...
              <tbody>
                <tr
                  v-for="(language, index) in officer.people.languages"
                  :key="index"
                >
                  <td class="border-b border-gray-100">{{ language.name }}</td>
                  <td class="border-b border-gray-100">
                    {{ language.reading.toUpperCase() }}
                  </td>
                  <td class="border-b border-gray-100">
                    {{ language.speaking.toUpperCase() }}
                  </td>
                  <td class="border-b border-gray-100">
                    {{ language.writing.toUpperCase() }}
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <div class="form-panel w-full mx-auto">
          <div class="w-full">
            <div class="relative w-full mt-4 mb-2 font-moul">
              ច- ប្រវត្តិការងារ
            </div>
            <table class="w-full">
              <tbody>
                    ...
                    <table class="w-full">
                      <tbody>
                        <tr>
                          ...
                          <td class="">
                            {{
                              officer.unofficial_date != undefined &&
                              officer.unofficial_date.length > 0
                                ? $toKhmer(
                                    dateFormat(
                                      new Date(officer.unofficial_date),
                                      "dd-mm-yyyy",
                                    ),
                                  )
                                : ""
                          ...
                          <td class="">
                            ថ្ងៃខែឆ្នាំតាំងស៊ុប់ក្នុងក្របខ័ណ្ឌរដ្ឋ ៖
                          </td>
                          <td class="">
                            {{
                              officer.official_date != undefined &&
                              officer.official_date.length > 0
                                ? $toKhmer(
                                    dateFormat(
                                      new Date(officer.official_date),
                                      "dd-mm-yyyy",
                                    ),
                                  )
                                : ""
                ...
                <tr>
                  <td>
                    <div class="relative w-full my-2 font-moul">
                      ច.១-មុខតំណែង (សូមបំពេញតាមលំដាប់ ពីថ្មីទៅចាស់)
                    </div>
                    <div class="relative w-full mb-2 font-moul">
                      ច.១.១-ក្នុងវិស័យសាធារណៈ
                    </div>
                    <table class="inside w-full border border-gray-100">
                      <thead>
                        <tr class="bg-gray-300">
                      ...
                      <tbody>
                        <tr
                          v-for="(job, index) in officer.job_backgrounds.filter(
                            (jb) => jb.sector == 0,
                          )"
                          :key="index"
                        >
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(formatDateSafe(job.start)) }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(formatDateSafe(job.end)) }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(job.organization) }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(job.sub_organization) }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(job.position) }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(job.skill_of_position) }}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <tr>
                  <td>
                    <div class="relative w-full my-4 font-moul">
                      ច.២-ការដំឡើងឋានន្តរស័ក្តិ និងថ្នាក់តាមវេនជ្រើសរើស អតីតភាព
                      ប្ដូរប្រភេទក្របខ័ណ្ឌ និងនិយ័តកម្មថ្នាក់ (សូមបំពេញតាមលំដាប់
                      ពីថ្មីទៅចាស់)
                    </div>
                    <table class="inside w-full border border-gray-100">
                      <thead>
                      ...
                      <tbody>
                        <tr
                          v-for="(rank, index) in officer.ranking_by_workings"
                          :key="index"
                        >
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(formatDateSafe(rank.date)) }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ rank.organization }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ rank.sub_organization }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ rank.sub_sub_organization }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{
                          ...
                          <td class="border-b border-gray-100">
                            {{ rank.rank != null ? rank.rank.name : "" }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{
                              changeTypes.find(
                                (t) => t.key == rank.changing_type,
                              ) != null
                                ? changeTypes.find(
                                    (t) => t.key == rank.changing_type,
                                  ).label
                ...
                <tr>
                  <td>
                    <div class="relative w-full my-4 font-moul">
                      ច.៣-ការដំឡើងឋានន្តរស័ក្តិ
                      និងថ្នាក់តាមសញ្ញាបត្រ(សូមបំពេញតាមលំដាប់ ពីថ្មីទៅចាស់)
                    </div>
                    <table class="inside w-full border border-gray-100">
                      <thead>
                        <tr class="bg-gray-300">
                      ...
                      <tbody>
                        <tr
                          v-for="(
                            rank, index
                          ) in officer.ranking_by_certificates"
                          :key="index"
                        >
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(formatDateSafe(rank.date)) }}
                ...
                <tr>
                  <td>
                    <div class="relative w-full my-4 font-moul">
                      ច.៤-ស្ថានភាពស្ថិតនៅក្រៅក្របខ័ណ្ឌដើម / ទំនេរពីមុខងារ
                      (សូមបំពេញតាមលំដាប់ ពីថ្មីទៅចាស់)
                    </div>
                    <table class="inside w-full border border-gray-100">
                      <thead>
                        <tr class="bg-gray-300">
                      ...
                      <tbody>
                        <tr
                          v-for="(work, index) in officer.pending_works.filter(
                            (w) => w.type == 0,
                          )"
                          :key="index"
                        >
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(formatDateSafe(work.start)) }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(formatDateSafe(work.end)) }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(work.organization) }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(work.position) }}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <tr>
                  <td>
                    <div class="relative w-full my-4 font-moul">
                      ច.៥-ស្ថានភាពស្ថិតនៅក្នុងភាពទំនេរគ្មានបៀវត្ស
                      (សូមបំពេញតាមលំដាប់ ពីថ្មីទៅចាស់)
                    </div>
                    <table class="inside w-full border border-gray-100">
                      <thead>
                ...
                <tr>
                  <td>
                    ...
                    <table class="inside w-full border border-gray-100">
                      ...
                      <tbody>
                        <tr
                          v-for="(medal, index) in officer.medal_histories"
                          :key="index"
                        >
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(medal.fid) }}
                          ...
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(formatDateSafe(medal.date)) }}
                          </td>
                          <td class="border-b border-gray-100">
                            {{ medal.organization }}
                          </td>
                ...
                <tr>
                  <td>
                    ...
                    <table class="inside w-full border border-gray-100">
                      ...
                      <tbody>
                        <tr
                          v-for="(penalty, index) in officer.panelty_histories"
                          :key="index"
                        >
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(penalty.fid) }}
                          ...
                          <td class="border-b border-gray-100">
                            {{ $toKhmer(formatDateSafe(penalty.date)) }}
                          </td>
                          <td class="border-b border-gray-100">
                ...
                <tr>
                  <td>
                    <div class="flex leading-6">
                      <svg
                        v-if="officer.additional_officer_type == 'politician'"
                        class="w-6 h-6 mr-1 text-gray-500"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 32 32"
                  ...
                  <td>
                    <div class="flex leading-6">
                      <svg
                        v-if="
                          officer.additional_officer_type == 'admin_official'
                        "
                        class="w-6 h-6 mr-1 text-gray-500"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink"
                  ...
                  <td>
                    <div class="flex leading-6">
                      <svg
                        v-if="
                          officer.additional_officer_type == 'admin_unofficial'
                        "
                        class="w-6 h-6 mr-1 text-gray-500"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink"
                  ...
                  <td>
                    <div class="flex leading-6">
                      <svg
                        v-if="
                          officer.additional_officer_type ==
                          'contracted_officer'
                        "
                        class="w-6 h-6 mr-1 text-gray-500"
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="w-full relative h-60">
          <div class="absolute left-0 top-0 w-80">
            <p class="indent-4 leading-6 text-justify">
              <span class="text-red-500 mr-1">*</span>អង្គភាព
              {{
                officer.organization != null ? officer.organization.name : ""
              }}
            </p>
            <p class="indent-4 leading-6 text-justify">
              ខ្ញុំសូមធានាទទួលខុសត្រូវចំពោះមុខច្បាប់ថា ព័ត៌មាន រូបថត
              និងហត្ថេខ្ជា ក្នុងជីវប្រវត្តិ{{ officer_type_name }}នេះ ពិតជារបស់
              <span class="font-moul">{{
                officer.people.lastname + " " + officer.people.firstname
              }}</span>
              ដែលជាមន្ត្រីកំពុងបំរើការងារនៅក្នុងក្រសួង
              និងអង្គភាពក្រោមឪវាទរបស់ក្រសួងពិតប្រាកដមែន។
            </p>
            <p class="text-center leading-6 whitespace-nowrap">
              ថ្ងៃ <span class="signature-date-line"></span> ទី
              <span class="signature-date-line"></span> ខែ
              <span
                class="signature-date-line signature-date-line-month"
              ></span>
              ឆ្នាំ
              <span class="signature-date-line signature-date-line-year"></span>
              ព.ស. {{ $toKhmer(String(today.getFullYear() + 543)) }}
            </p>
            <p class="text-center leading-6">
              <span
                class="signature-date-line signature-date-line-place"
              ></span>
              ថ្ងៃទី <span class="signature-date-line"></span> ខែ
              <span
                class="signature-date-line signature-date-line-month"
              ></span>
              ឆ្នាំ {{ $toKhmer(today.getFullYear()) }}
            </p>
            <p class="text-center leading-6 font-moul mt-10">ប្រធាននាយកដ្ឋាន</p>
          </div>
          <div class="absolute right-0 top-0 w-80 overflow-visible">
            <p class="indent-4 leading-6 text-justify">
              <span class="text-red-500 mr-1">*</span>សាមីខ្លួន
            </p>
            <p class="indent-4 leading-6 text-justify">
              ខ្ញុំសូមធានាទទួលខុសត្រូវចំពោះមុខច្បាប់
              ព័ត៌មានបានបំពេញក្នុងជីវប្រវត្តិនេះ ពិតជាត្រឹមត្រូវប្រាកដមែន។
            </p>
            <div class="signature-date-lines-wrap">
              <p class="text-center leading-6 whitespace-nowrap">
                ថ្ងៃ {{ signatureDates.weekday }} ទី {{ signatureDates.day }} ខែ
                {{ signatureDates.month }} ឆ្នាំ
                {{ signatureDates.year || "" }} ព.ស.
                {{ $toKhmer(String(today.getFullYear() + 543)) }}
              </p>
              <p class="text-center leading-6">
                {{ signatureDates.place || "រាជធានីភ្នំពេញ" }} ថ្ងៃទី
                {{ signatureDates.day2 }} ខែ {{ signatureDates.month2 }} ឆ្នាំ
                {{ signatureDates.year2 ? $toKhmer(signatureDates.year2) : "" }}
              </p>
            </div>
  ...
  setup(props) {
    ...
    try {
      ...
      if (raw) {
        ...
        signatureDates.weekday =
          parsed.weekday != null ? String(parsed.weekday) : "";
        ...
        signatureDates.month2 =
          parsed.month2 != null ? String(parsed.month2) : "";
